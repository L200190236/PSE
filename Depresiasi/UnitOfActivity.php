...
<html>
    <head>
        ...
        <title>L200190236_L200190259</title>
        ...
        <div class="container">
            <nav class="navbar navbar-inverse" role="navigation">
                <div class="navbar-header">
                    ...
                    <a href="index.html"><h1 align="center">Perhitungan Depresiasi</h1></a>
                </div>
            </nav>
        </div>
    </div>
...
<div class="container bg-dark text-white">
    ...
    ?>
    <div class="rows">
        <form action="UnitOfActivity.php" method="get">
            ...
            <center><table align="center">
                    ...
                    <tr>
                     ...
                     <tr>
                        <td>Residu Value</td>
                        <td>:</td>
                        <td><input type="text" name="UU" class="form-control" value="<?php echo $UU; ?>"  required>
                    </td>
                    </tr>
                </table></center>
